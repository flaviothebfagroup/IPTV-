(() => {
  ...
  const BUILD = "v50";
  const LS_KEY = "bfa_linktree_editor_draft_v50";
...
function setTab(tab){
  ...
  const PREVIEW_KEY = "bfa_linktree_preview_prefs_v50";
  ...
  const FLOAT_KEY = "bfa_linktree_preview_float_v50";
  let floatOn = false;
...
function openLogoModal(){
  ...
  function wire(){
    ...
    (function(){
      ...
      const KEY = "bfa_preview_dock_size_v50";
      try{
