(() => {
  ...
  const BUILD = "v48";
  const LS_KEY = "bfa_linktree_editor_draft_v48";
...
function setTab(tab){
  ...
  const PREVIEW_KEY = "bfa_linktree_preview_prefs_v48";
  ...
  const FLOAT_KEY = "bfa_linktree_preview_float_v48";
  let floatOn = false;
...
function openLogoModal(){
  ...
  function wire(){
    ...
    (function(){
      ...
      const KEY = "bfa_preview_dock_size_v48";
      try{
