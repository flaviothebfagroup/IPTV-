(() => {
  ...
  const BUILD = "v47";
  const LS_KEY = "bfa_linktree_editor_draft_v47";
...
function setTab(tab){
  ...
  const PREVIEW_KEY = "bfa_linktree_preview_prefs_v47";
  ...
  const FLOAT_KEY = "bfa_linktree_preview_float_v47";
  let floatOn = false;
...
function openLogoModal(){
  ...
  function wire(){
    ...
    (function(){
      ...
      const KEY = "bfa_preview_dock_size_v47";
      try{
