(() => {
  ...
  const BUILD = "v45";
  const LS_KEY = "bfa_linktree_editor_draft_v45";
...
function setTab(tab){
  ...
  const PREVIEW_KEY = "bfa_linktree_preview_prefs_v45";
  ...
  const FLOAT_KEY = "bfa_linktree_preview_float_v45";
  let floatOn = false;
...
function openLogoModal(){
  ...
  function wire(){
    ...
    (function(){
      ...
      const KEY = "bfa_preview_dock_size_v45";
      try{
