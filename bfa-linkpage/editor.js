(() => {
  ...
  const BUILD = "v46";
  const LS_KEY = "bfa_linktree_editor_draft_v46";
...
function setTab(tab){
  ...
  const PREVIEW_KEY = "bfa_linktree_preview_prefs_v46";
  ...
  const FLOAT_KEY = "bfa_linktree_preview_float_v46";
  let floatOn = false;
...
function openLogoModal(){
  ...
  function wire(){
    ...
    (function(){
      ...
      const KEY = "bfa_preview_dock_size_v46";
      try{
